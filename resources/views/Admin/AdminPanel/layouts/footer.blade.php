...
<!-- Morris.js charts -->
<script src="{{URL::to('/Design/adminlte/bower_components/raphael/raphael.min.js')}}"></script>
<script src="{{URL::to('/Design/adminlte/bower_components/morris.js/morris.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{URL::to('/Design/adminlte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
<script src="{{URL::to('/Design/adminlte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
...
<!-- Slimscroll -->
<script src="{{URL::to('/Design/adminlte/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<!-- FastClick -->
<script src="{{URL::to('/Design/adminlte/bower_components/fastclick/lib/fastclick.js')}}"></script>
<!-- AdminLTE App -->
